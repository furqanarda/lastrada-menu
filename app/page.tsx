...
export default function Home() {
  const { isValidToken } = useAccess()

  // If user has a valid token, show the language selection page
  // If no valid token, AccessGuard will redirect to access denied
  return (
    <AccessGuard requireValidToken={true} requireOpenHours={false}>
